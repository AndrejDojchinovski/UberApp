...
public class Passenger extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    private boolean isOrderCancelled = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRequestCar.setOnClickListener(Passenger.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        {
            if (ContextCompat.checkSelfPermission(Passenger.this, Manifest.permission.ACCESS_FINE_LOCATION)
...
//
                    ...
                    requestCar.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                             if (e == null) {
                                 Toast.makeText(Passenger.this, "A car request is sent", Toast.LENGTH_SHORT).show();

                                 btnRequestCar.setText("Cancel order");
                                 isOrderCancelled = false;
                             }
                        }
                    });
            ...
            carRequestQuery.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> requestList, ParseException e) {
                    if ( requestList.size() > 0 && e == null) {
                        ...
                        for (ParseObject orderRequest : requestList) {
                            orderRequest.deleteInBackground(new DeleteCallback() {
                                @Override
                                public void done(ParseException e) {

                                    if (e ==null) {
                                        Toast.makeText(Passenger.this, "Request/s deleted.", Toast.LENGTH_SHORT).show();
                                    }
